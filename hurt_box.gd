...
func die():
	...
	# 💰 Otorgar monedas al jugador
	var coins_dropped: int = randi_range(5, 15)  # Monedas aleatorias entre 5 y 15
	GameState.add_coins(coins_dropped)
	
	# ✨ Opcional: Crear efecto visual de drop
	# (Se puede mejorar con una escena de partículas de monedas)
